...
#SBATCH --account=bdshe07  # Run job under project <project>
...
cp iosmaugparams_jet_hydro5.h iosmaugparams.h

cd ..

cd src
#cp usersource_jet_hydro4.cu usersource.cu #modify to use working amplitude
cp usersource_jet_hydro5.cu usersource.cu

#cp usersource_jet_hydro3.cu usersource.cu
